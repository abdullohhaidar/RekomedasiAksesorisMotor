            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="tables">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{ route('adminTableVelg') }}">Velg</a>
                    <a class="nav-link" href="{{ route('adminTableBan') }}">Tire</a>
                    <a class="nav-link" href="{{ route('adminTableSuspensi') }}">Suspension</a>
                  </li>
                </ul>
              </div>
            </li>
